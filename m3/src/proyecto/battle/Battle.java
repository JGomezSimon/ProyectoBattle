...
public class Battle {
    public static Warrior warrior1 = new Warrior("Lintia", "assets/guerreros/lintia.png", 50, 5, 6, 4, 3, 1);
    public static Warrior warrior2 = new Warrior("Renil", "assets/guerreros/renil.png", 60, 3, 10, 3, 3, 2);
    public void init(){
